...
import { BracesIcon, Globe2Icon, GroupIcon, HardDriveIcon, PhoneIcon, Settings2Icon, SettingsIcon, Users2Icon, WebhookIcon } from 'lucide-react';
...
export default function TeamsSettingsLayout() {
  ...
  const teamSettingRoutes = [
    ...
    {
      path: `/t/${team.url}/settings/contacts`,
      label: t`Contacts`,
      icon: PhoneIcon,
    },
    {
